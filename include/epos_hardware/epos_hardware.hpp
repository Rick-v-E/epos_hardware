...
namespace epos_hardware
{
  ...
  struct Actuator
  {
    ...
    double profile_position_velocity;
    double profile_position_acceleration;
    double profile_position_deceleration;
    double profile_velocity_acceleration;
    double profile_velocity_deceleration;
